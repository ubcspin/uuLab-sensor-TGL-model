...
datadirrg <- "C:/Users/Laura/Documents/School/2017-2022 PhD/Projects/uuLab/new data/sheary_rg/sheary_rg"
...
write.csv(featureData, file="gesturefeaturefileshearYrg.csv", row.names=FALSE)
