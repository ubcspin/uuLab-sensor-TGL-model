...
windowFeatures <- c("SXmax", "SXmin", "SXmean", "SXmedian", "SXvar", "SXtotalvar", "SXauc", 
	"XmaxSX", "XminSX", "XmeanSX", "XmedianSX", "XvarSX", "XtotalvarSX", "XaucSX", 
	"YmaxSX", "YminSX", "YmeanSX", "YmedianSX", "YvarSX", "YtotalvarSX", "YaucSX", 
	"subconditionSX", "subjectSX", "filecountSX", "gestureSX")
...
write.csv(featureData, file="shearxFeatures.csv", row.names=FALSE)
