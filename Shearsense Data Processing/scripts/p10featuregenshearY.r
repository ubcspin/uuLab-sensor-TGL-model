...
windowFeatures <- c("maxSY", "minSY", "meanSY", "medianSY", "varSY", "totalvarSY", "aucSY", 
	"XmaxSY", "XminSY", "XmeanSY", "XmedianSY", "XvarSY", "XtotalvarSY", "XaucSY", 
	"YmaxSY", "YminSY", "YmeanSY", "YmedianSY", "YvarSY", "YtotalvarSY", "YaucSY", 
	"subconditionSY", "subjectSY", "filecountSY", "gestureSY")
...
write.csv(featureData, file="shearYFeatures.csv", row.names=FALSE)

write.csv(needsProcessing, file="shearYneedsProcessing.csv", row.names=FALSE)
